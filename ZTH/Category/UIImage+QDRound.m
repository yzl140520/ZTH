...
#import "UIImage+QDRound.h"
#import "UIImage+QDAlpha.h"

@implementation UIImage (QDRound)
...
{
    // 添加透明图片
    UIImage * image = [self qd_imageWithAlpha];
    // 图片大小
    ...
    //绘制边框图片
    UIColor *borderColor = RGBAHEX(0x28070f, .08f);
